    ...
    <div className="bg-gradient-to-br from-base-100 via-base-200 to-base-300">
      ...
      <nav className="bg-base-100/80 backdrop-blur-md border-b border-primary/20 sticky top-0 z-50 shadow-lg">
        <div className="max-w-7xl mx-auto p-4 flex items-center justify-between">
          ...
          >
            <div className="size-10 rounded-xl from-primary via-secondary to-accent flex items-center justify-center shadow-lg">
              <FolderCodeIcon className="size-6 text-white" />
            </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <h1 className="text-5xl lg:text-7xl font-black leading-tight">
              ...
              <br />
              <span className="text-base-content">Get Hired</span>
            </h1>
